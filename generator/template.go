...
{{- end}}
	...
	TableName: "{{$tableName}}",
{{- range .Fields}}
	{{.FieldName}}: Field{FieldName: "{{.TagName}}", TableName: "{{$tableName}}"},
{{- end}}
}
{{end}}
`
